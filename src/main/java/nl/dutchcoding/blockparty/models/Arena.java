...
public class Arena implements ConfigurationSerializable {
    ...
    public Arena(Map<String, Object> map) {
        ...
        // Safely deserialize locations with error handling
        try {
            this.pos1 = (Location) map.get("pos1");
        } catch (Exception e) {
            this.pos1 = null;
            nl.dutchcoding.blockparty.BlockParty.getInstance().getLogger().warning("Failed to load pos1 for arena " + name + ": " + e.getMessage());
        }
        ...
        try {
            ...
            this.pos2 = null;
            nl.dutchcoding.blockparty.BlockParty.getInstance().getLogger().warning("Failed to load pos2 for arena " + name + ": " + e.getMessage());
        }
        ...
        try {
            ...
            nl.dutchcoding.blockparty.BlockParty.getInstance().getLogger().warning("Failed to load spawnLocation for arena " + name + ": " + e.getMessage());
        }
        ...
        try {
            ...
            this.waitLobby = null;
            nl.dutchcoding.blockparty.BlockParty.getInstance().getLogger().warning("Failed to load waitLobby for arena " + name + ": " + e.getMessage());
        }
    ...
    public String getSetupStatus() {
        ...
        if (spawnLocation == null) missing.add("spawn");
        if (waitLobby == null) missing.add("lobby");
