...
public class GameManager {
    ...
    public boolean joinGame(Player player, Arena arena) {
        ...
        // Check if game is already playing or ending
        if (game.getState() == Game.GameState.PLAYING || game.getState() == Game.GameState.ENDING) {
            player.sendMessage(plugin.getMessageManager().getMessage("game-already-started"));
            return false;
        }
